...
var Evaluator_1 = require("@formio/utils/Evaluator");
var dom = __importStar(require("@formio/utils/dom"));
var sanitize_1 = require("@formio/utils/sanitize");
var model_1 = require("@formio/model");
var object_1 = require("@formio/lodash/lib/object");
    ...
    return function (BaseClass) {
        return /** @class */ (function (_super) {
            ...
            Object.defineProperty(ExtendedComponent.prototype, "defaultTemplate", {
                get: function () {
                    return function (ctx) { return "<span>".concat(ctx.t('Unknown Component'), "</span>"); };
                },
                enumerable: false,
                configurable: true
            });
