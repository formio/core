...
var NestedComponent = /** @class */ (function (_super) {
    ...
    NestedComponent.prototype.createComponent = function (component) {
        var comp = index_1.Components.createComponent(component, this.options, this.data);
        comp.parent = this;
        comp.root = this.root || this;
        return comp;
    };
    NestedComponent.prototype.createComponents = function () {
        var _this = this;
        (this.component.components || []).forEach(function (comp) {
            return _this.components.push(_this.createComponent(comp));
        });
    };
    NestedComponent.prototype.renderContext = function () {
