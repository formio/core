...
function ComponentWithModel(ModelClass) {
    return function () {
        ...
        var compProps = props.length ? props.reduce(function (result, prop) { return _.merge(result, prop); }, {}) : {};
        if (!compProps.type) {
        ...
        return /** @class */ (function (_super) {
            ...
            function ExtendedComponent() {
                 ...
                 */
                _this.template = compProps.template;
                /**
        ...
        }(ModelClass(compProps)));
    };
}
exports.ComponentWithModel = ComponentWithModel;
exports.Component = ComponentWithModel(Model_1.Model);
// Add the default component.
Components_1.Components.addBaseComponent(exports.Component, 'component');
Components_1.Components.addComponent(exports.Component());
