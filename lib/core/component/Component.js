...
var Component = /** @class */ (function (_super) {
    ...
    function Component(component, options, data) {
        ...
        _this.component = util_1.lodash.merge(_this.defaultSchema, _this.component);
    ...
    Object.defineProperty(Component.prototype, "dataValue", {
         ...
         */
        get: function () {
            return util_1.lodash.get(this.data, this.component.key);
        },
        /**
        ...
        set: function (value) {
            if (this.component.key) {
                util_1.lodash.set(this.data, this.component.key, value);
            }
        },
        enumerable: false,
        configurable: true
