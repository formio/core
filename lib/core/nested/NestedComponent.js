...
exports.NestedComponent = exports.NestedComponentWithModel = exports.NestedComponentBase = void 0;
var Components_1 = require("../Components");
var Component_1 = require("../component/Component");
var NestedModel_1 = require("../../model/NestedModel");
exports.NestedComponentBase = Component_1.ComponentWithModel(NestedModel_1.NestedModel(Components_1.Components));
function NestedComponentWithModel(ModelClass) {
    return function NestedComponent() {
        var props = [];
        ...
        return /** @class */ (function (_super) {
            ...
            Object.defineProperty(ExtendedNestedComponent.prototype, "defaultTemplate", {
                get: function () {
                    return function (ctx) { return "<div ref=\"nested\">" + ctx.instance.renderComponents() + "</div>"; };
                },
                enumerable: false,
                configurable: true
            });
        ...
        }(ModelClass.apply(void 0, props)));
    };
}
exports.NestedComponentWithModel = NestedComponentWithModel;
exports.NestedComponent = NestedComponentWithModel(exports.NestedComponentBase);
Components_1.Components.addBaseComponent(exports.NestedComponent, 'nested');
Components_1.Components.addComponent(exports.NestedComponent());
