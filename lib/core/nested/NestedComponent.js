...
var NestedComponent = /** @class */ (function (_super) {
    ...
    function NestedComponent(component, options, data) {
        ...
        _this.template = function (ctx) { return "<div ref=\"nested\">" + ctx.content + "</div>"; };
        _this.components = [];
        if (!options.noInit) {
            _this.init();
        }
    ...
    NestedComponent.prototype.createComponent = function (component, data) {
        var comp = __1.Components.createComponent(component, __assign({ noInit: true }, this.options), data);
        comp.parent = this;
    ...
    NestedComponent.prototype.renderContext = function (context) {
        ...
        context.content = (_a = this.components) === null || _a === void 0 ? void 0 : _a.reduce(function (tpl, comp) {
