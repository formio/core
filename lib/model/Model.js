...
function Model(props) {
    ...
    return function (BaseClass) {
        ...
        return /** @class */ (function (_super) {
            ...
            BaseModel.prototype.bubble = function (event) {
                var _a;
                var args = [];
                for (var _i = 1; _i < arguments.length; _i++) {
                    args[_i - 1] = arguments[_i];
            ...
            BaseModel.prototype.emit = function (event) {
                var _a, _b;
                var args = [];
                for (var _i = 1; _i < arguments.length; _i++) {
                    args[_i - 1] = arguments[_i];
            ...
            BaseModel.prototype.on = function (event, fn) {
                var _a;
                var args = [];
            ...
            BaseModel.prototype.once = function (event, fn) {
                var _a;
                var args = [];
                for (var _i = 2; _i < arguments.length; _i++) {
                    args[_i - 2] = arguments[_i];
            ...
            BaseModel.prototype.off = function (event) {
                var _a;
                var args = [];
                for (var _i = 1; _i < arguments.length; _i++) {
                    args[_i - 1] = arguments[_i];
