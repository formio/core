...
function NestedArrayModel(Factory) {
    return function (props) {
        if (props === void 0) { props = {}; }
        return /** @class */ (function (_super) {
            __extends(NestedArrayModel, _super);
            function NestedArrayModel() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            Object.defineProperty(NestedArrayModel.prototype, "defaultValue", {
                get: function () {
                    return [];
                },
                enumerable: false,
             ...
             */
            NestedArrayModel.prototype.row = function (index) {
             ...
             */
            NestedArrayModel.prototype.removeRow = function (index) {
                var _this = this;
             ...
             */
            NestedArrayModel.prototype.addRow = function (data, index) {
                if (data === void 0) { data = {}; }
             ...
             */
            NestedArrayModel.prototype.setRowData = function (rowData, index) {
                this.dataValue[index] = rowData;
             ...
             * @param index
             */
            NestedArrayModel.prototype.rowChanged = function (rowData, index) {
                var changed = false;
             ...
             * @returns
             */
            NestedArrayModel.prototype.createComponents = function (data) {
                var _this = this;
                this.rows = [];
                var added = [];
             ...
             */
            NestedArrayModel.prototype.createRowComponents = function (data, index) {
                if (index === void 0) { index = 0; }
                var comps = _super.prototype.createComponents.call(this, data);
                this.rows[index] = comps;
                return comps;
            };
            NestedArrayModel.prototype.getIndexes = function (value) {
                return {
                    min: 0,
                    max: (value.length - 1)
                };
            };
            NestedArrayModel.prototype.eachRowValue = function (value, fn) {
            ...
            Object.defineProperty(NestedArrayModel.prototype, "emptyValue", {
                /**
            ...
            Object.defineProperty(NestedArrayModel.prototype, "dataValue", {
                /**
             ...
             * @param value
             */
            NestedArrayModel.prototype.hasChanged = function (value) {
                var _this = this;
             ...
             * @param value
             */
            NestedArrayModel.prototype.setValue = function (value) {
                var changed = false;
            ...
            return NestedArrayModel;
        }(NestedDataModel_1.NestedDataModel(Factory)(props)));
    };
}
