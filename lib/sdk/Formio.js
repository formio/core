...
var Formio = /** @class */ (function () {
    ...
    Formio.setToken = function (token, opts) {
        ...
        if (!token) {
            ...
            try {
                ...
                console.log("Error removing token: ".concat(err.message));
            }
        ...
        if (Formio.tokens[tokenName] !== token) {
            ...
            try {
                ...
                console.log("Error setting token: ".concat(err.message));
            }
        }
    ...
    Formio.getToken = function (options) {
        ...
        try {
            ...
            console.log("Error retrieving token: ".concat(e.message));
            return '';
        }
    };
    /**
    ...
    Formio.getUser = function (options) {
        ...
        try {
            ...
            console.log("Error getting user: ".concat(e.message));
            return {};
        }
    };
    /**
