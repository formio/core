...
var Plugins = /** @class */ (function () {
    ...
    Plugins.pluginWait = function (pluginFn) {
        ...
        return Promise.all(Plugins.plugins.map(function (plugin) {
            var _a;
            return (_a = (plugin[pluginFn] || lodash_1.noop)).call.apply(_a, __spreadArray([plugin], args, false));
        }));
    };
    /**
    ...
    Plugins.pluginGet = function (pluginFn) {
        ...
        var callPlugin = function (index) {
            ...
            return Promise.resolve((_a = (plugin[pluginFn] || lodash_1.noop)).call.apply(_a, __spreadArray([plugin], args, false)))
    ...
    Plugins.pluginAlter = function (pluginFn, value) {
        ...
        return Plugins.plugins.reduce(function (value, plugin) {
            return (plugin[pluginFn] || Plugins.identity).apply(void 0, __spreadArray([value], args, false));
        }, value);
    };
    /**
