        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (this.component.isMultipleMasksField) {
                    ...
                    if (formioInputMask) {
                        inputMask = mask_1.getInputMask(formioInputMask);
                    }
                    value = value ? value.value : value;
                }
                else {
                    inputMask = mask_1.getInputMask(this.settings.mask);
                }
                if (value && inputMask) {
                    return [2 /*return*/, mask_1.matchInputMask(value, inputMask)];
                }
