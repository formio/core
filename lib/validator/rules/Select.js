...
var _a = (0, fetch_ponyfill_1.default)(), fetch = _a.fetch, Headers = _a.Headers, Request = _a.Request;
...
var SelectRule = /** @class */ (function (_super) {
    ...
    SelectRule.prototype.check = function (value, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        query = [];
                        (0, lodash_1.each)(requestOptions.qs, function (val, key) {
                            query.push("".concat(encodeURIComponent(key), "=").concat(encodeURIComponent(val)));
                        });
                        requestOptions.url += (requestOptions.url.includes('?') ? '&' : '?') + query.join('&');
                        // Set custom headers.
                        if (schema.data && schema.data.headers) {
                            (0, lodash_1.each)(schema.data.headers, function (header) {
                                if (header.key) {
