...
var UniqueRule = /** @class */ (function (_super) {
    ...
    UniqueRule.prototype.check = function (value, options) {
        if (value === void 0) { value = this.component.dataValue; }
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var form, submission, db, path, query, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        form = options.form, submission = options.submission, db = options.db;
                        // Skip if we don't have a database connection
                        if (!db) {
                            return [2 /*return*/, true];
                        }
                        path = "data.".concat(this.component.path);
                        query = { form: form._id };
                        ...
                        return [4 /*yield*/, db.findOne(query)];
                    case 1:
                        result = _a.sent();
