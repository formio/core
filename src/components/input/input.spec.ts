...
describe('Input Component', () => {
    ...
    it('Should create input of different types', () => {
        ...
        assert.equal(comp.render(), `<input ref="input" type="number" id="input-firstname" name="input-firstname" one="two" three="four"></input>`);
    });

    it('Should render a Form input with label and input', async () => {
        ...
        assert.equal(parentElement.innerHTML, '<span ref="htmlcontainer">' +
