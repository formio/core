...
describe('ArrayComponent', () => {
    ...
    it ('Should allow complex data structures', () => {
        ...
        assert.equal((arrComp.components[2] as any).components[0].dataValue, employees[0].department.name);
        assert.equal((arrComp.components[2] as any).components[1].dataValue, employees[0].department.phoneNumber);
        ...
        assert.equal((arrComp.components[3] as any).components[0].dataValue, employees[0].children[0].firstName);
        assert.equal((arrComp.components[3] as any).components[1].dataValue, employees[0].children[0].dob);
        assert.equal((arrComp.components[3] as any).components[2].dataValue, employees[0].children[1].firstName);
        assert.equal((arrComp.components[3] as any).components[3].dataValue, employees[0].children[1].dob);
        ...
        assert.equal((arrComp.components[6] as any).components[0].dataValue, employees[1].department.name);
        assert.equal((arrComp.components[6] as any).components[1].dataValue, employees[1].department.phoneNumber);
        ...
        assert.equal((arrComp.components[7] as any).components[0].dataValue, employees[1].children[0].firstName);
        assert.equal((arrComp.components[7] as any).components[1].dataValue, employees[1].children[0].dob);
        assert.equal((arrComp.components[7] as any).components[2].dataValue, employees[1].children[1].firstName);
